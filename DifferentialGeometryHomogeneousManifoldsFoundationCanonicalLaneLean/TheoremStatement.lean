import DifferentialGeometryHomogeneousManifoldsFoundationCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation :=
  { sourceKey := "DifferentialGeometryHomogeneousManifoldsFoundationCanonicalLaneLean",
    theoremObject := "Differential Geometry Homogeneous Manifolds Foundation",
